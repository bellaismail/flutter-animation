...
class _RiveAnimationScreenState extends State<RiveAnimationScreen> with SingleTickerProviderStateMixin{
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('#rive_animation'),
      ),
      body: PageView.builder(
        ...
        itemBuilder: (context, index) => Center(
          child: RiveAnimation.asset(list[index]),
        ),
        // itemBuilder: (context, index) => Center(
